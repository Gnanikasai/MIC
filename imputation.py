...
# information for each column: count - The number of not-empty values. mean - The average (mean) value. std - The standard deviation
    ...
    def fit_transform(self, X, method='Linear', iter=5, verbose=True):
        ...
        for i in range(iter):
            ...
            for column in null_cols:
                ...
                train_x, val_x, train_y, val_y = train_test_split(not_null_X, not_null_y, test_size=0.33,
                                                                  random_state=42)
